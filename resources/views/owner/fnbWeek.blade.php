...
<body>
  <div class="owner-fnb-weekly" data-scroll-to="ownershowFnbDaily">
    <div class="owner-fnb-weekly-child"></div>
    <a class="owner-fnb-weekly-inner">
      <div class="vuesaxlinearlogout-group">
        <img class="vuesaxlinearlogout-icon1" alt="" src="{{ asset('css/public2/vuesaxlinearlogout.svg') }}" />
    ...
    <div class="frame-group">
      <a class="icon-short-text-group" href="showTicketWeek" id="frameLink1">
        <img class="icon-short-text1" alt="" src="{{ asset('css/public2/-icon-short-text.svg') }}" />
      ...
      <a class="icon-bar-chart-group" href="downloadReport" id="frameLink2">
        <img class="icon-bar-chart1" alt="" src="{{ asset('css/public2/-icon-bar-chart.svg') }}" />
