...
<body>
  <div class="owner-fnb-hour" data-scroll-to="ownershowFnbHour">
    <div class="owner-fnb-hour-child"></div>
    <a class="owner-fnb-hour-inner">
      <div class="vuesaxlinearlogout-parent4">
        <img class="vuesaxlinearlogout-icon7" alt="" src="{{ asset('css/public2/vuesaxlinearlogout1.svg') }}" />
    ...
    <div class="frame-parent5" data-scroll-to="groupContainer">
      <a class="icon-short-text-parent4" href="showTicketHour" id="frameLink1">
        <img class="icon-short-text7" alt="" src="{{ asset('css/public2/-icon-short-text1.svg') }}" />
      ...
      <a class="icon-bar-chart-parent5" href="downloadReport" id="frameLink2">
        <img class="icon-bar-chart7" alt="" src="{{ asset('css/public2/-icon-bar-chart.svg') }}" />
