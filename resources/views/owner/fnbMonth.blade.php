...
<body>
  <div class="owner-fnb-monthly" data-scroll-to="ownershowFnbMonth">
    <div class="owner-fnb-monthly-child"></div>
    <a class="owner-fnb-monthly-inner">
      <div class="vuesaxlinearlogout-parent">
        <img class="vuesaxlinearlogout-icon" alt="" src="{{ asset('css/public2/vuesaxlinearlogout.svg') }}" />
    ...
    <div class="frame-parent">
      <a class="icon-short-text-parent" href="showTicketMonth" id="frameLink1">
        <img class="icon-short-text" alt="" src="{{ asset('css/public2/-icon-short-text.svg') }}" />
      ...
      <a class="icon-bar-chart-parent" href="downloadReport" id="frameLink2">
        <img class="icon-bar-chart" alt="" src="{{ asset('css/public2/-icon-bar-chart.svg') }}" />
